...
cat > /etc/motd <<EOF
Owned by TianZhiHuiQi Technology Co., Ltd
This is online environment, please operate carefully
If you have any questions, contact the operation and maintenance team.
EOF
